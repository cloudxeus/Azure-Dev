...
namespace AzureEventHub_Receive
{
    class Program
    {
        private static string connection_string = "Endpoint=sb://sqlnamespace1000.servicebus.windows.net/;SharedAccessKeyName=Listen;SharedAccessKey=7+gejNQsidrsAYKEF+tkq4zoiM6q3KjK+PmepGTnp+c=;EntityPath=sqlhub";
