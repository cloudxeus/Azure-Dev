...
namespace AzureEventHub_Send
{
    class Program
    {
        private static string connection_string = "Endpoint=sb://appnamespace1000.servicebus.windows.net/;SharedAccessKeyName=Send;SharedAccessKey=Jye60sbZcNFCfZGElJRIAYeUGH2cB57s/OIGlQoTOY0=;EntityPath=newhub";
